...
//     precio: 5500,
//     imagen: getImageUrl("Panetela Grande de Chocolate.jpg")
//   },
//   {
//     id: 4,
//     nombre: "Panetela Grande con cobertura de flores",
//     precio: 4700,
//     imagen: getImageUrl("Panetela Grande con cobertura de flores.jpg")
//   },
...
export function is_in_dev_mode(): boolean {
  return !(window.location.hostname === 'derikgm.github.io');
}
